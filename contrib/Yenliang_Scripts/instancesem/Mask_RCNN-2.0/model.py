...
def detection_targets_graph(proposals, gt_class_ids, gt_boxes, gt_masks, config):
    ...
    positive_count = tf.to_float(positive_count)
    negative_count = tf.div(positive_count,tf.constant(config.ROI_POSITIVE_RATIO)) - positive_count
    negative_count = tf.to_int32(negative_count)
