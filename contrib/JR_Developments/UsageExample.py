...
# Image Calibration:
wv2 = WVCK.WV2params()
calibratedData = WVCK.RadiometricCalibrator(img, wv2,sub_array = croppedData)
calibratedData.calibrate()
# get the associated lat long information for every point in the image:
long, lat, plotPatch = hf.projectImage(calibratedData.get_calibrated_data(), x0, y0, x1, y1, cornerPoints, rpcInformation)
